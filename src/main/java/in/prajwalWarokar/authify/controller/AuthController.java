...
import in.prajwalWarokar.authify.io.AuthRequest;
import in.prajwalWarokar.authify.io.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest request) {
        try {
            ...
            final UserDetails userDetails = appUserDeatailsService.loadUserByUsername(request.getEmail());
